            ...
            cell: (info: any) => {
                return (
                    <div className="group relative flex flex-col items-center">
                        {/* TEST: problem sampe sini ketika mau link up BUTTON EDIT ORDER DATATABLE dengan halama EDIT-ORDER */}
                        <button className='rounded-md bg-blue-600 text-white p-1' onClick={() => navigate(`/edit-order/${info.getValue()}`)}>
    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans text-gray-900 pb-10">
            ...
            <main className="max-w-4xl mx-auto p-4">
                {isErrDataSource == true ? (
                    <h1>{errInfoDataSource?.message}</h1>
                ) : (
